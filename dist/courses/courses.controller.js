...
let CoursesController = class CoursesController {
    ...
    async updateCourse(updateCourse) {
...
__decorate([
    (0, common_1.Get)('/get_course_info/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CoursesController.prototype, "getCourseInfo", null);
__decorate([
    (0, common_1.Put)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [courses_dto_1.UpdateCourseDto]),
    __metadata("design:returntype", Promise)
